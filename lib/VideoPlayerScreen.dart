...
class VideoController extends GetxController {
  ...
  // Observable position and duration
  ...
  void onInit() {
    super.onInit();
    videoController =
        vp.VideoPlayerController.network(
        ...
        children: [
          ...
          Positioned(
            ...
            child: IconButton(
              ...
              onPressed: () {
                Get.off(() => VideoPlayerScreen()); // Replace back
              },
            ),
          ),
          Positioned(
            ...
            child: Obx(() {
              ...
              final dur = controller.totalDuration.value;
              return Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      controller.videoController.value.isInitialized
                          ? '${controller.formatDuration(pos)} / ${controller.formatDuration(dur)}'
                          : '0:00 / 0:00',
...
class VideoPlayerScreen extends StatelessWidget {
              ...
              child: Row(
                children: [
                  IconButton(
                    ...
                    onPressed: () {
                      Get.find<VideoController>().videoController.pause();
  ...
  Widget _buildChatSection(VideoController controller) {
    // ... no changes here
              ...
              child: Container(
                ...
                child: Obx(
                    ...
                    itemBuilder: (context, index) =>
                        _buildStyledChatMessage(controller, index),
                  ),
                ),
              ),
            ),
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [
                      (message['avatarColor'] as Color).withOpacity(0.8),
                      message['avatarColor'] as Color,
                    ],
                  ),
                  shape: BoxShape.circle,
                  boxShadow: [
                            ...
                            child: Row(
                              children: [
                                Icon(
                                  Icons.favorite,
                                  size: 14,
                                  color: replyLiked ? Colors.red : Colors.grey,
                                ),
                                const SizedBox(width: 4),
                                Text(
                                  '${reply['likes'] ?? 0}',
